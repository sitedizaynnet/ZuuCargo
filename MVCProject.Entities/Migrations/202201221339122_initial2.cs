                ...
                c => new
                    {
                        ...
                        TrackingNo = c.String(),
                        SenderName = c.String(),
                        SenderIdVATNumber = c.Short(),
                        SenderTelephone = c.String(),
                        SenderEmail = c.String(),
                        SenderPostalCode = c.Short(),
                        ...
                        ChargeTo = c.String(),
                        ThirdPartyAccountNo = c.Short(),
                        ThirdPartyCompanyName = c.String(),
                        ThirdPartyCountry = c.String(),
                        ServiceLevel = c.String(),
                        PackageCount = c.Short(),
                        TotalWeight = c.Short(),
                        DimensionalWeight = c.Short(),
                        IsSameSize = c.Boolean(),
                        AdditionalHandlingCharge = c.Short(),
                        LargePacketSurchargeApplies = c.Short(),
                        ReferenceNo1 = c.String(),
                        ReferenceNo2 = c.String(),
                        DescriptionOfGoods = c.String(),
                        IsSample = c.Boolean(),
                        IsDocument = c.Boolean(),
                        IsSaturdayDelivery = c.Boolean(),
